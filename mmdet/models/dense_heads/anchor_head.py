...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def forward_single(self, x_td, x_bu):
        ...
        """
        cls_score = self.conv_cls(x_td)
        bbox_pred = self.conv_reg(x_bu)
        return cls_score, bbox_pred

    def forward(self, feats_td, feats_bu):
        ...
        Returns:
            tuple: A tuple of classification scores and bbox prediction.
                ...
                - bbox_preds (list[Tensor]): Box energies / deltas for all \
                    ...
                    is num_anchors * 4.
        """
        return multi_apply(self.forward_single, feats_td, feats_bu)
    ...
    def aug_test(self, feats_td, feats_bu, img_metas, rescale=False):
        ...
        """
        return self.aug_test_bboxes(feats_td, feats_bu, img_metas, rescale=rescale)